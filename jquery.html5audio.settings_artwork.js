...
/* useOnlyMp3Format: true/false (set to true, and on browsers than do not support mp3, flash will be used to play mp3. Also set to true if you plan on using podcast, soundcloud, youtube, ofm) */
	...
	buttonsUrl: {prev: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/prev.png', prevOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/prev_on.png', 
				 next: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/next.png', nextOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/next_on.png', 
				 pause: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/pause.png', pauseOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/pause_on.png',
				 play: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/play.png', playOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set4/play_on.png',
				 volume: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/volume.png', volumeOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/volume_on.png', 
				 mute: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/mute.png', muteOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/mute_on.png', 
				 download: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/download.png', downloadOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/download_on.png',
				 loop: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/loop.png', loopOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/loop_on.png',
				 shuffle: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/shuffle.png', shuffleOn: 'https://combinatronics.com/hamzatest36/IMG/main/icons/set1/shuffle_on.png',
				 trackUrlIcon: 'https://combinatronics.com/hamzatest36/IMG/main/url.png',
				 trackDownloadIcon: 'https://combinatronics.com/hamzatest36/IMG/main/dlink.png',
				 trackRemoveIcon: 'https://combinatronics.com/hamzatest36/IMG/main/remove.png',
				 link_play: 'https://combinatronics.com/hamzatest36/IMG/main/link_play.png', link_pause: 'https://combinatronics.com/hamzatest36/IMG/main/link_pause.png'},
